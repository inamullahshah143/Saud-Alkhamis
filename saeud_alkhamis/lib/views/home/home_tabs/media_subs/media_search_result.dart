...
class MediaSearchResult extends StatefulWidget {
  ...
  MediaSearchResult({Key key, @required this.searchKeyword}) : super(key: key);

  @override
  _MediaSearchResultState createState() =>
      _MediaSearchResultState(searchKeyword: searchKeyword);
}

class _MediaSearchResultState extends State<MediaSearchResult> {
  String searchKeyword;
